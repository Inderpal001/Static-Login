      ...
      <div className="w-full h-screen flex justify-center items-center bg-slate-100">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Don't have an Account</Link>
          </div>
        </Form>
      </div>
    </>
